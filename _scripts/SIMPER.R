...
library(vegan) # why do I have to reinstall it every time on the little mac?
...
fish.comp <- select(tbl_df(fish), Area, Sample_number, Depth, Species, MaxN, Habitat, Year, Sampling_period) 
